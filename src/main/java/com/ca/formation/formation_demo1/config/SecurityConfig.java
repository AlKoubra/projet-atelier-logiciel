package com.ca.formation.formation_demo1.config;

import com.ca.formation.formation_demo1.config.jwtConfig.JwtFilter;
                ...
                .exceptionHandling()
                        .authenticationEntryPoint(
                                ((request, response, authException) -> {
                                    logger("Demande pas autoriser - "+authException.getMessage());
